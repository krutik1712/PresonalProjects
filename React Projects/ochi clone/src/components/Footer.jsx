...
function Footer() {
  return (
    <div className='w-full h-screen rounded-t-xl flex font-["Founde Grotesk"] overflow-hidden'>

        {/* First Container */}
        <div className="w-1/2 h-full flex flex-col justify-between py-[6vh] px-10">
            <div className="heading">
                <h1 className='text-[6vw] uppercase leading-none tracking-tighter font-semibold -mb-[1.5vh]'>
                    Eye-
                </h1>
                <h1 className='text-[6vw] uppercase leading-none tracking-tighter font-semibold -mb-[1.5vh]'>
                    Opening
        ...
        <div className="py-[6vh] px-10">
            ...
            <div className="grid grid-cols-2">
                ...
                <div className="font-['Neue_Montreal'] py-10 ">
                    <h1>S:</h1>
                    <br />
                    <a className='block underline' href="#">Instagram</a>
                    <a className='block underline' href="#">Behance</a>
                    <a className='block underline' href="#">Facebook</a>
                    <a className='block underline' href="#">Linkedin</a>
                </div>
                ...
                <div className="font-['Neue_Montreal']">
                    <h1>L:</h1>
                    <br />
                    <a className='block underline' href="#">202-1965 W 4th Ave</a>
                    <a className='block underline' href="#">Vancouver, Canada</a>
                    <br />
                    <a className='block underline' href="#">30 Chukarina St</a>
                    <a className='block underline' href="#">Lviv, Ukraine</a>
                </div>

                <div className="font-['Neue_Montreal'] ml-56">
                    <h1>M:</h1>
                    <br />
                    <a className='block underline' href="#">Home</a>
                    <a className='block underline' href="#">Services</a>
                    <a className='block underline' href="#">Our work</a>
                    <a className='block underline' href="#">About us</a>
                    <a className='block underline' href="#">Insights</a>
                    <a className='block underline' href="#">Contact us</a>
                </div>

                <div className="font-['Neue_Montreal'] py-4">
                    <h1>S:</h1>
                    <br />
                    <a className='block underline' href="#">hello@ochi.design</a>
                </div>

            </div>
            
            <div className="w-full flex gap-80">
                <div className="copy pt-10 text-zinc-400">© ochi design 2024. <span className='cursor-pointer underline'>Legal Terms</span></div>
                <div className="copy pt-10 text-zinc-400 cursor-pointer">Website by Obys</div>
            </div>
        </div>
    </div>
  )
