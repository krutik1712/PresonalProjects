        ...
        <Section id='how-to-use' crosses>
            <div className='container'>
                <Heading
                    ...
                    text='Brainware unlocks the potential of AI-powered applications.'
                />
                <div className="relative">
                    <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                        ...
                        <div className="relative z-1 max-w-[17rem] ml-auto">
                            ...
                            <p className='body-2 mb-[3rem] text-n-3'>Brainware unlocks the potential of AI-powered applications.</p>
                            <ul className='body-2'>
                        ...
                        <Generating className='absolute left-4 right-4 bottom-5 border border-n-1/10 lg:left-1/2 lg:right-auto lg:bottom-8 lg:w-[31rem] md:-translate-x-1/2' />
                    </div>
                    <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                        ...
                        <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                            ...
                            <div className='relative rounded-xl h-[20rem] bg-n-8 overflow-hidden md:h-[25rem]'>
                                <img
                                    src={service3}
                                    alt="greenRobot"
                                    width={520}
